...
<body>
	...
	<section style="height: 960px">
		<div id="container">
			...
			<div style="width: 800px; height: 300px;">
				<p>
					<span style="font-size: 25px; font-weight: bold">아이디 찾기</span>
				</p>
				...
				<form action="loginpage.jsp" method=post name="id">
					<div style="width: 800px; height: 100px; border: 1px solid">
						...
						<div style="margin-top: 35px; margin-left: 320px">
							...
							<input type="radio" name="finded_id" value="<%=rs.getString("id")%>"> <span
 ...
 %>
					...
					<div style="margin-left: 295px; margin-top: 20px;">
						<button type="button" class="btn btn-success" style="width: 100px;" value="로그인 하기" onClick="radio_check()">로그인하기</button>
				</form>
				<a href="infosearch.jsp?finded_id=<%=rs.getString("id")%>"><button type="button"
						class="btn btn-success" style="width: 110px;">비밀번호찾기</button></a>
			</div>
